  ...
  useEffect(() => {
    ...
    return () => {
      ...
      if (worldRef.current && rendererRef.current) {
        worldRef.current.removeChild(rendererRef.current.domElement);
      }
    };
  }, []);
